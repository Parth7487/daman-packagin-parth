  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="bg-gray-100 py-16 px-4">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center text-[#265186] mb-12">Our Product Range</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              />
              <div className="p-4">
                <h3 className="text-lg font-semibold mb-2">HDPE Bottles</h3>
                <p className="text-gray-600 mb-4">Various sizes from 100ml to 1000ml</p>
                <Link to="/products" className="text-[#265186] hover:underline font-medium">View Details</Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              />
              <div className="p-4">
                <h3 className="text-lg font-semibold mb-2">HDPE Jerry Cans</h3>
                <p className="text-gray-600 mb-4">Sizes from 1L to 50L</p>
                <Link to="/products" className="text-[#265186] hover:underline font-medium">View Details</Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              />
              <div className="p-4">
                <h3 className="text-lg font-semibold mb-2">Open Top Drums</h3>
                <p className="text-gray-600 mb-4">Various sizes from 15L to 60L</p>
                <Link to="/products" className="text-[#265186] hover:underline font-medium">View Details</Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              <img 
                src="/lovable-uploads/0778ba5a-760d-40b1-985d-60832ff5daf5.png" 
                alt="Open Mouth Drums" 
                className="w-full h-48 object-contain bg-gray-50 p-4"
              />
              <div className="p-4">
                <h3 className="text-lg font-semibold mb-2">Open Mouth Drums</h3>
                <p className="text-gray-600 mb-4">Sizes from 30L to 235L</p>
                <Link to="/products" className="text-[#265186] hover:underline font-medium">View Details</Link>
              </div>
            </div>
          </div>
